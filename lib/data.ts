...
export const dataOfProjects: Project[] = [
  ...
  },
  {
    ...
    title: "PathWay",
    description:
      "PathWay is a comprehensive platform designed to streamline , Effortlessly turn your ideas into a fully functional, responsive, no-code SaaS website in just minutes with the set of free components for Framer.",
    tech: "Next.js | TypeScript | Tailwind CSS | CSS(3) | Figma",
  ...
  },
  {
    ...
    tech: "Next.js | TypeScript | RTK Query | Tailwind CSS | CSS(3) | Figma",
    image: "/assets/Se-University1.png",
  ...
  // },
  {
    ...
    title: "Vanlife",
    description:
      "Vanlife App is about renting vans for any kind of trips, built with React and Bootstrap for a seamless user experience and responsive design across devices and screen sizes.",
    tech: "React.js | React Router | Bootstrap | CSS(3) | Postman | Mirage js | Vite js",
    image: "/assets/vanlife1.png",
  ...
  },
  {
    ...
    description:
      "A responsive admin dashboard built with React, Material UI, and Nivo charts for data visualization, providing an intuitive interface for managing and analyzing data with a sleek design and seamless user experience across devices.",
    tech: "React.js | React Router | React Hook Form | Material Ui | CSS(3) | Nivo | Vite js",
    image: "/assets/AdminDashboard1.png",
  ...
  },
  {
    ...
    title: "Weather App",
    description:
      "A weather app that provides real-time weather updates using React and APIs for a seamless user experience and responsive design across devices and screen sizes.",
  ...
  },
  {
    ...
    title: "Kasper",
    description:
      "A clean and modern landing page template built with HTML, CSS, and JavaScript for a responsive and engaging user experience that effectively showcases products or services with a sleek design and smooth animations.",
    tech: "HTML(5) | CSS(3) | JavaScript",
    image: "/assets/Kasper1.png",
  ...
  // },
  {
    ...
    title: "Dashboard",
    description:
      "A minimalistic dashboard interface built with HTML, CSS, and JavaScript for data visualization and user interaction in a clean and intuitive design that focuses on simplicity and ease of use.",
    tech: "HTML(5) | CSS(3) | JavaScript",
  ...
  },
  {
    ...
    title: "Leon",
    description:
      "A corporate website template showcasing services and portfolios with a clean and professional design built with HTML, CSS, and JavaScript for a seamless user experience and responsive layout across devices.",
    tech: "HTML(5) | CSS(3) | JavaScript",
    image: "/assets/leon1.png",
  ...
  },
  {
    ...
    title: "Bondi",
    description:
      "A stylish business website built with Bootstrap for responsiveness and modern design, showcasing services and portfolios with a clean and professional layout that adapts seamlessly across devices and screen sizes.",
    tech: "HTML(5) | CSS(3) | JavaScript | Bootstrap",
    image: "/assets/bondi1.png",
  ...
  },
  {
    id: 16,
    title: "VivaDecor",
    description: "An elegant interior design website built with Bootstrap for a responsive and modern design, showcasing services and portfolios with a clean and professional layout that adapts seamlessly across devices and screen sizes.",
    tech: "HTML(5) | CSS(3) | JavaScript | Bootstrap",
    image: "/assets/VivaDecor1.png",
