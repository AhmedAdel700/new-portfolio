                        ...
                        <div className="relative flex flex-col lg:flex-row lg:items-end justify-between gap-8 pb-10 sm:pb-16">
                            ...
                            <div className="space-y-6">
                                ...
                                <motion.h2
                                    ...
                                    className={`text-white font-black tracking-tighter uppercase ${isFullPage ? 'text-7xl md:text-8xl lg:text-[10rem]' : 'text-5xl md:text-7xl lg:text-8xl'}`}
                                >
                                    THE <br />
                        ...
                        <div className="flex flex-wrap gap-2 md:gap-3">
                            {categories.map((cat) => (
                                <button
                                    ...
                                    className={`relative cursor-pointer px-5 py-2 md:px-7 md:py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-colors duration-300 ${activeCategory === cat
                                            ? 'text-[#030014]'
