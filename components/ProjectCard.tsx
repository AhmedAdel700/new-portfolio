...
export default function ProjectCard({ project, disableTilt = false }: ProjectCardProps) {
    ...
    return (
      <motion.div
        ...
        initial={false}
        className="group relative h-120 md:h-full md:min-h-135 w-full select-none overflow-hidden rounded-2xl bg-[#080320] border border-white/10 transition-all duration-500 hover:border-[#7FFFD4]/40 hover:shadow-[0_0_30px_rgba(127,255,212,0.1)]"
        style={{ perspective: "1200px" }}
      >
        {/* Inner Glow / Rim Light */}
        <div className="absolute inset-0 z-40 rounded-2xl border border-white/5 pointer-events-none" />
        <div className="absolute inset-px z-40 rounded-2xl border border-white/3 pointer-events-none" />
        ...
        <div className="absolute inset-0 z-0 overflow-hidden transform translate-z-0">
          ...
          <div className="absolute inset-0 z-10">
            ...
            <div className="absolute inset-0 bg-linear-to-t from-[#040115] via-[#040115]/30 to-transparent opacity-90" />
        ...
        <motion.div
          layout
          className="relative h-full z-20 p-6 md:p-8 flex flex-col justify-end"
        >
          {/* Header Section */}
        ...
        <div className="absolute inset-0 z-30 pointer-events-none">
          ...
          <div className="absolute bottom-0 left-0 w-full h-1px bg-linear-to-r from-transparent via-white/20 to-transparent" />
          ...
          {/* Scanline Effect */}
          <motion.div
            className="absolute inset-0 bg-linear-to-b from-transparent via-white/5 to-transparent h-[15%] w-full z-10"
            animate={{
        ...
        <div className="absolute top-1/2 -right-4 -translate-y-1/2 rotate-90 flex items-center gap-4 opacity-10 group-hover:opacity-30 transition-opacity duration-500">
          <span className="text-[8px] font-mono text-white tracking-[0.5em] uppercase">
            Project_System_v2.0
          </span>
