...
import { ArrowLeft, ArrowUpRight, Monitor, Globe, Code2, Zap, Filter, Search } from 'lucide-react';
        ...
        <main className="relative w-full min-h-screen bg-[#030014] overflow-hidden selection:bg-[#7FFFD4] selection:text-black font-sans">
            ...
            <div className="relative z-10 pt-32 pb-20">
                <div className="container mx-auto px-6 max-w-[1450px]">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 border-b border-white/5 pb-16">
                            <div className="space-y-6">
                                ...
                                <motion.h1 
                                    ...
                                    className="text-white text-7xl md:text-8xl lg:text-[10rem] font-black tracking-tighter uppercase leading-[0.85]"
                                >
                                    THE <br />
                    ...
                    {/* Filter Bar - Improved with Layout Animation */}
                    <motion.div 
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
